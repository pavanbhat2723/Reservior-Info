    ...
    <div id="header">
      <div id="logo">
	   ...
	   <div id="menubar">
        ...
        <li><a href="FarmerWaterTimeTable.php">Time Table</a></li>
         <li><a href="FarmerWaterLevelList.php">Level</a></li>
         <li><a href="FarmerReserviorsList.php">Reserviors</a></li>
         <li><a href="FarmerInfo.php">Info</a></li>
